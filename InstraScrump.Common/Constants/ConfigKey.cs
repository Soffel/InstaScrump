namespace InstaScrump.Common.Constants
{
    public class ConfigKey
    {
        public const string Download_Key = "Download";
        public const string Log_Key = "Log";
        public const string Csv_Key = "Csv";
        public const string Login_File_Key = "SaveLoginFile";
        ...
        public const string Pswd_Key = "password";
        public const string Prod_Db_Key = "Prod";
        public const string Test_Db_Key = "Test";
    }
}
